...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx }/sysmgr/toUserInfo.action">个人信息</a></li>
		<li class="active"><a href="${ctx }/sysmgr/toChangePwd.action">修改密码</a></li>
	</ul><br/>
	<form id="userChangePwdForm" class="form-horizontal" method="post">
